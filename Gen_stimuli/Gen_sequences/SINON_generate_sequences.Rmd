...
# Read data
rm(list=ls())
if( .Platform$OS.type == "windows" ){ dirinput <- 'V:/spinco_data/'
} else if ( .Platform$OS.type == "unix"){ dirinput <- '/run/user/891957923/gvfs/smb-share:domain=d.uzh.ch,server=idnas12.d.uzh.ch,share=g_psyneulin_data$,user=gfraga/spinco_data'
}
