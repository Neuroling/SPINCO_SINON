function [wave]=vocoder_gfg(exc, mapping, filters, EnvelopeExtractor, smooth, nCh, InputSignal, Srate, MinFreq, MaxFreq, varargin)
% Adapted by GFraga-Gonzalez 2022 (based on function modified by A.H-A since 2003)
%
...
InputSignal=InputSignal-mean(InputSignal); %----------remove any DC bias---
...
[blo,alo]=butter(3, smooth/srat2); % display: freqz(blo,alo,[],srate)
